...
You can install the development version of rrminfo from [GitHub](https://github.com/AntsaVerse/rrminfo) with:
...
- Discretize multiple-choice categorical variables (priority needs) into individual sector columns.
...
Combine alerts, evaluations, RRM, and Post-RRM data into a single analysis dataset.
...
e.g: List of completed RRM responses that have not received a post-RRM response as of the current date.
```{r}
